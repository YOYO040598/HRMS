...
def test_emp_login(emp_id, password):
    ...
    try:
        ...
        print(f"EMP LOGIN SUCCESS ({emp_id}):", res.getcode(), res.read().decode('utf-8'))
    except urllib.error.HTTPError as e:
        print(f"EMP LOGIN ERROR ({emp_id}):", e.code, e.read().decode('utf-8'))

test_emp_login('employee@hrms.com', 'HrmsEmployee@2026!')
test_emp_login('EMP004', 'HrmsEmployee@2026!')
