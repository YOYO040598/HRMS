  ...
  return (
    <div className="space-y-8 p-1 sm:p-2">
      ...
      <div className="grid grid-cols-1 md:grid-cols-4 gap-6 auto-rows-auto">
        ...
        <div className="md:col-span-2 bg-gradient-to-tr from-[#5e6ad2] to-[#7c89f8] rounded-3xl p-8 text-white relative overflow-hidden shadow-lg shadow-[#5e6ad2]/15 flex flex-col justify-between min-h-[220px]">
          ...
          <div className="absolute -bottom-8 -left-8 w-36 h-36 bg-[#a5b4fc]/20 rounded-full blur-xl pointer-events-none" />
        ...
        <div className="bento-card md:col-span-2 bg-white rounded-3xl p-6 flex flex-col justify-between min-h-[220px]">
          ...
          <div className="grid grid-cols-3 gap-3">
            <Link to="/emp/attendance" className="p-3 bg-gray-50 hover:bg-indigo-50/50 hover:text-[#5e6ad2] rounded-2xl text-center transition-all border border-gray-100/50">
              <Clock size={20} className="mx-auto mb-1.5 text-[#5e6ad2]" />
