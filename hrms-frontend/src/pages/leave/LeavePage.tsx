...
import { CalendarDays, Plus, Clock, CheckCircle, XCircle, AlertTriangle, Sparkles } from 'lucide-react';
    ...
    <div className="space-y-8 p-1 sm:p-2">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
        <div>
          ...
          <h2 className="text-3xl font-extrabold text-gray-900 tracking-tight">Leaves Overview</h2>
          <p className="text-sm text-gray-500 font-medium mt-1">Submit new leave requests and review your quota history.</p>
        </div>
        <button 
          ...
          <div className="bg-white rounded-3xl w-full max-w-lg p-8 shadow-2xl border border-[#e8e1d5]/60">
            <div className="flex items-center justify-between mb-6">
              <h3 className="text-2xl font-black text-gray-900 tracking-tight flex items-center gap-2">
                <CalendarDays className="text-[#ea580c]" /> Request Leave
              </h3>
      ...
      <div className="bg-white rounded-3xl border border-[#e8e1d5]/60 overflow-hidden shadow-[0_4px_20px_-2px_rgba(28,25,23,0.03)]">
        <h3 className="text-lg font-bold text-gray-900 p-6 pb-4 border-b border-gray-100 flex items-center gap-2">
          <Clock size={18} className="text-gray-400" /> Recent Leave Applications
        </h3>
          ...
          <table className="w-full">
            ...
            <tbody className="divide-y divide-gray-100">
              {applications.length === 0 ? (
                <tr><td colSpan={8} className="px-6 py-12 text-center text-gray-400 text-sm font-medium">No leave requests found</td></tr>
