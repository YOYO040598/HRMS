      ...
      <div className="w-full max-w-[460px] relative z-10">
        <div className="bg-white/[0.03] backdrop-blur-[24px] -webkit-backdrop-blur-[24px] border border-white/[0.08] rounded-[32px] p-8 sm:p-10 shadow-[0_32px_64px_rgba(0,0,0,0.6)]">
          ...
          <div className="flex items-center gap-3 mb-6 justify-center">
            ...
            <span className="text-2xl font-bold tracking-tight text-white">HRMS <span className="text-xs font-semibold px-2 py-0.5 rounded bg-white/10 text-orange-300 ml-1">Employee</span></span>
          </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            <div className="space-y-2">
              <label className="block text-[11px] font-bold text-orange-300 uppercase tracking-wider">Employee ID</label>
            ...
            <button
              type="submit"
              disabled={loading}
              className="w-full py-4 bg-gradient-to-r from-[#ea580c] to-[#f97316] text-white font-bold rounded-xl hover:brightness-110 active:scale-[0.98] transition-all shadow-lg shadow-[#ea580c]/25 flex items-center justify-center gap-2 text-sm uppercase tracking-wider cursor-pointer border-none"
            >
              {loading ? (
